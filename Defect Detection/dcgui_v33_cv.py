#!/usr/bin/python
# -*- coding: UTF-8 -*-
# 串口读取代码待测试  添加键盘绑定翻页（page_bind） 移除保存日志按钮
#将self.defect_info_st = scrolledtext.ScrolledText
...
class App:
    ...
    def create_tab(self):
        ...
        self.tab_process.focus_set() # 焦点锁定时才会触发键盘事件
        self.tab_process.bind("<Key>", self.bind_page)
